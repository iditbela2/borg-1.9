...
public class BorgAlgorithm implements Algorithm {
	...
	public void step() {
		...
		borg.setParameter("initialPopulationSize", properties.getInt("initialPopulationSize", 100));
		borg.setParameter("minimumPopulationSize", properties.getInt("minimumPopulationSize", 100));
		borg.setParameter("maximumPopulationSize", properties.getInt("maximumPopulationSize", 10000));
