...
#
# Note: There is a slow memory leak caused by the function closure returned
# by magicWrapper and rdyncall's callback function.  Unless you are invoking
# borg thousands of times, you will not be affected by this issue.
#
# Please cite the following paper in any works that use or are derived from
# this program.
#
...
BORG_Algorithm_set_maximum_window_size(pi)v;
